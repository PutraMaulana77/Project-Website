...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
      <a class="navbar-brand" href="{{ url('/User/home') }}"> USER</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="{{ url('/User/guru') }}">Guru</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ url('/User/mapel') }}">Mapel</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ url('/User/pembelajaran') }}">Pembelajaran</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ url('/User/about') }}">Tentang</a>
          </li>
          <li class="nav-item">
  ...
  <h2>Tentang Kami</h2>
    ...
    <p>
      Terima kasih telah memilih kami dalam pengelolaan data pendidikan. Jika Anda memiliki pertanyaan atau umpan balik, jangan ragu untuk <a href="{{ url('/User/contact') }}">menghubungi kami</a>.
    </p>
  </div>
