  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link" href="{{ url('User/abouthome') }}">About</a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div class="col-lg-4">
      <div class="card">
        <div class="card-body">
          ...
          <a href="{{ url('/User/index') }}" class="btn btn-primary">Go to Data Guru</a>
        </div>
      </div>
    </div>
    <div class="col-lg-4">
      <div class="card">
        <div class="card-body">
          ...
          <a href="{{ url('/User/index2') }}" class="btn btn-primary">Go to Data Mapel</a>
        </div>
      </div>
    </div>
    <div class="col-lg-4">
      <div class="card">
        <div class="card-body">
          ...
          <a href="{{ url('/User/index3') }}" class="btn btn-primary">Go to Data Pembelajaran</a>
        </div>
      </div>
    </div>
  </div>
