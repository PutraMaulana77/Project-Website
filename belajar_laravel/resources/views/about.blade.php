...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    <div class="container-fluid">
      <a class="navbar-brand" href="{{ url('/home') }}"> MJP|| Manajemen Jadwal Pembelajaran</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="{{ url('/guru') }}">Guru</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ url('/mapel') }}">Mapel</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{ url('/pembelajaran') }}">Pembelajaran</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container">
    <h2>Tentang Kami</h2>
    <p>
      Selamat datang di platform siswa Admin kami! Kami siap untuk berkomitmen dalam memberikan Anda alat terbaik dalam pengelolaan data pendidikan.
    </p>
    <p>
    ...
    <p>
      Terima kasih telah memilih kami dalam pengelolaan data pendidikan. Jika Anda memiliki pertanyaan atau umpan balik, jangan ragu untuk <a href="{{ url('/contact') }}">menghubungi kami</a>.
    </p>
  </div>
