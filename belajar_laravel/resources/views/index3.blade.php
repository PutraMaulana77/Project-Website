  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary">
    ...
    <div class="container">
        ...
        <div class="container mt-3">
            <form action="/pembelajaran/cari" method="GET" class="d-flex">
                ...
                @if(request()->has('cari'))
                <a href="/pembelajaran" class="btn btn-danger ms-2">X</a>
                @endif
            </form>
        </div>
        ...
        <div class="container mt-3">
            <form action="" method="get" class="d-flex">
                <!-- Tombol TAMBAH -->
                <a class="btn btn-primary" href="/pembelajaran/tambah">+ TAMBAH</a>
                <!-- TOMBOL PRINT/CETAK -->
            ...
            <table id="myTable" class="table table-striped table-bordered mt-1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $p->Hari }}</td>
                        <td>
                            <a href="/pembelajaran/ubah/{{ $p->ID_Mapel }}" class="btn btn-success btn-sm">UBAH</a>
                            <a href="/pembelajaran/hapus/{{ $p->ID_Mapel }}" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin akan menghapus data ini?')">HAPUS</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
